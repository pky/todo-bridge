      ...
      <div class="px-2 sm:px-4 py-2 sm:py-3 flex items-center justify-between">
        <div class="flex items-center gap-1 sm:gap-3">
          ...
          <div class="flex items-center gap-2">
            <img src="/icons/icon.svg" alt="TodoBridge" class="h-6 w-6 sm:h-8 sm:w-8" />
            <span class="text-sm font-medium tracking-tight text-gray-700 sm:text-base">TodoBridge</span>
          </div>
          <!-- 検索バー -->
        ...
        <div class="flex items-center gap-1 sm:gap-4">
          ...
          <div class="flex items-center gap-1 md:gap-2">
            ...
            />
            <span class="text-gray-700 hidden md:inline">アカウント</span>
          </div>
          <button
            @click="handleLogout"
